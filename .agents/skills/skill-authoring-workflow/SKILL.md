...
If targeting Codex custom skill upload:
...
- Descriptions that say what the skill is but not when Codex should trigger it.
...
- Anthropic's [Complete Guide to Building Skills for Codex](https://resources.anthropic.com/hubfs/The-Complete-Guide-to-Building-Skill-for-Codex.pdf)
- `scripts/add-a-skill.sh`
- `scripts/build-a-skill.sh`
- `scripts/find-a-skill.sh`
- `scripts/test-a-skill.sh`
