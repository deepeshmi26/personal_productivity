...
- **Not about choosing AI tools** — Codex vs. ChatGPT doesn't matter; architecture matters
...
**Current AI Usage:**
- What AI tools/systems do you use? (ChatGPT, Codex, custom agents, etc.)
...
- Using Codex Projects for PRD writing
