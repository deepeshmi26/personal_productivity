...
**AI-shaped version:** AGENTS.md files, evidence databases, constraint registries AI agents reference; two-layer memory architecture; Research→Plan→Reset→Implement cycle to prevent context rot
...
- **Not about AI tools:** Using Codex vs. ChatGPT doesn't matter. Redesigning workflows matters.
...
3. **Level 3 (Transitioning / Context Engineering Emerging):** "We've started using AGENTS.md files and project instructions. Constraints registry exists. We're identifying what to persist vs. retrieve. Experimenting with Research→Plan→Reset→Implement cycle."
...
2. **Level 2 (Emerging):** "I have a few saved prompts I reuse. Maybe some custom GPTs or Codex Projects."
...
- **Next Steps:** Build AGENTS.md files, start constraints registry, create operational glossary
...
4. Add to AGENTS.md or project instructions
...
- Week 4: Add context to AGENTS.md files
...
- AI Usage: Codex Projects for research, custom workflows emerging
...
**Failure Mode:** "Should we use Codex or ChatGPT?"
