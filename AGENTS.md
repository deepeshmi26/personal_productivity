...
1. `cp .env.example .env` — set `DATABASE_URL` to your local Postgres connection string and `PORT=8080`
...
## Learning plans (read before backend mentorship work)

- [docs/learning/backend-architecture-learning-plan.md](docs/learning/backend-architecture-learning-plan.md) — User's backend architecture learning plan, calibration profile, teaching pattern, and coverage map. Source of truth for backend mentorship pacing and concept-first Learn5-applied learning.
